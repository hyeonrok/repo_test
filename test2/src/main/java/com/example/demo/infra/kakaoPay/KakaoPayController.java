package com.example.demo.infra.kakaoPay;
...
public class KakaoPayController {
	...
	private String kakaopayAdmin;
	
	@Value("${kakao_rest_key}")
	private String kakaoRestKey;
	
	@ResponseBody
	@RequestMapping(value ="/redirectKPay")
	public String kakaopay() {
		try {
			...
			connection.setRequestProperty("Authorization", kakaopayAdmin); // 어드민 키
	...
	@RequestMapping(value ="/kakaoPayTest")
	public String kakaoPayTest() {
		
		return "kakaoPay/kakaoPayTest";
	}
